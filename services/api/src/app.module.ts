...
export class AppModule implements NestModule { configure(consumer: MiddlewareConsumer) { consumer.apply(securityContextMiddleware, tenantMiddleware, branchMiddleware).forRoutes('*'); } }

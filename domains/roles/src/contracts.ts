...
export type RemoveRoleCommand = AssignRoleCommand;
...
export interface RoleCommands {
  create(command: CreateRoleCommand): Promise<RoleRecord>;
  assign(command: AssignRoleCommand): Promise<void>;
  remove(command: RemoveRoleCommand): Promise<void>;
}
